...
const RHdemands = () => {
  ...
  const renderStateCell = (demand) => {
    ...
    return (
      ...
      >
        <MenuItem value="En cours" sx={{ color: '#f4b942' }}>En cours</MenuItem>
        <MenuItem value="Approuvé" sx={{ color: '#2e7d32' }}>Approuvé</MenuItem>
        <MenuItem value="Refusé" sx={{ color: '#d32f2f' }}>Refusé</MenuItem>
      </Select>
    );
  ...
  return (
    <Grid container spacing={2} style={{ justifyContent: 'center' }}>
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          ...
          >
            ...
            <MenuItem value="Prêt d'investissement ">Prêt d'investissement</MenuItem>
      ...
      <Dialog open={openStateDialog} onClose={handleCloseStateDialog}>
        ...
        <DialogActions>
          <Button onClick={handleCloseStateDialog} color="primary">Annuler</Button>
