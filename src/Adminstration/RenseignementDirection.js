...
const RenseignementCommercial = () => {
  ...
  const handleSaveRequest = async () => {
    try {
      const requiredFields = ['DEMANDEUR', 'DATE_DEMANDE', 'CLIENT', 'ENCOURS_ADMIN'];
          ...
          <Grid container spacing={3} style={{ marginTop: 5 }}>
            ...
            <Grid item xs={6}>
              <TextField
                ...
                label="Encours final"
                type="number"
                value={currentRequest.ENCOURS_ADMIN}
                onChange={(e) => setCurrentRequest({ ...currentRequest, ENCOURS_ADMIN: e.target.value })} />
            </Grid>
            <Grid item xs={6}>
              <Typography component="th">Avis Direction</Typography>

              <Select
                fullWidth
                value={currentRequest.AVIS_ADMIN}
                onChange={(e) => {
            ...
            <Grid item xs={6}>
              ...
              <Select
                ...
                disabled={currentRequest.AVIS_ADMIN === "Non Approuvé"}
              >
            ...
            <Grid item xs={12}>
              <TextField
                ...
                multiline
                rows={4}
                value={currentRequest.COMMENTAIRE_ADMIN}
                onChange={(e) => setCurrentRequest({ ...currentRequest, COMMENTAIRE_ADMIN: e.target.value })}
                margin="normal"
              />
            </Grid>
