...
const ClientList = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios.get(`${BASE_URL}/api/clients?page=${page + 1}&pageSize=${pageSize}`)
      .then(response => {
  ...
  const columns = [
    ...
    { id: 'INTITULE_CLIENT', label: 'Intitulé Client', minWidth: 100 },
    { id: 'TEL_CLIENT_F', label: 'Téléphone Client', minWidth: 130 },
    { id: 'ADR_C_FACT_1', label: 'Adresse Client', minWidth: 100 },
