...
import RHdemands from './RhDepartementRequests';
import SavMnagementImport from './SavMnagementImport';
      ...
      {value === index && (
        <Box sx={{ p: 3 }}>
          ...
          {index === 0 && displayMode === 'card' && (
            <SavMnagementImport selectedClientType={"clientsCspd"} setOpen={handleClickOpen} displayMode={displayMode} searchTerm={searchTerm} />
          )}
